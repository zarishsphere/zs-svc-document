...
git clone https://github.com/zarishsphere/zs-svc-document.git
cd zs-svc-document
...
See [docs.zarishsphere.com/api/zs-svc-document](https://docs.zarishsphere.com/api/zs-svc-document) for the full OpenAPI 3.1 specification.
